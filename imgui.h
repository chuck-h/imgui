...
namespace ImGui
{
	...
	IMGUI_API bool          InputU32Int(const char* label, int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0);
	IMGUI_API bool          InputU16Int(const char* label, int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0);
	IMGUI_API bool          InputU8Int(const char* label, int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags flags = 0);
...
struct ImDrawList
{
	...
	IMGUI_API void  AddTextVertical(const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, bool rotateCCW = false, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL);
	IMGUI_API void  AddTextVertical(const ImVec2& pos, ImU32 col, const char* text_begin, bool rotateCCW, const char* text_end = NULL);
...
struct ImFont
{
	...
	IMGUI_API void              RenderTextVertical(ImDrawList* draw_list, float size, ImVec2 pos, ImU32 col, const ImVec4& clip_rect, const char* text_begin, const char* text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false, bool rotateCCW = false)const;
